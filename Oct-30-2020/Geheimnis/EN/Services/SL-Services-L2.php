...
<body>
<form action="SL-Services-S-L2.php" method="post" name="form1" id="form1">
    ...
    <tbody>
      ...
      <tr>
		...
		<?php
	     ...
	     $Sql="SELECT ID,NAME FROM SL_SERVICES_EN ORDER BY ID ";
	     $uresult = $mysqli->query($Sql);
...
<?php
			$Sql="SELECT * FROM SERVICES_ID_L2_EN ORDER BY DATE DESC" ;
			$uresult = $mysqli->query($Sql);
?>
