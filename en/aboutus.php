          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav justify-content-end2">
                      <li><a href="../aboutus.php" onclick="_blank">中文</a></li>
                      <li>|</li>
                      <li><a href="./aboutus.php">English</a></li><li>|</li>
					  <li><a href="./aboutus.php">繁體</a></li>
                  </ul>
              </div>
          </nav>
      </header>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="static_main_content">
                                ...
                                <div class="static_text2">
                                    <h3></h3>
                                    <p>We leverage our collective resources, experiences and capabilities and form most suitable teams to meet particular needs of our clients.  We combine industry experiences with our legal skills and assist our clients to develop best legal solutions that are also aligned with their business strategies.  We also work closely with our external technical experts, testing and appraisal institutes, investigation agencies and public relation agencies to effectively and efficiently provide our coordinated services.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
