          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item active"><a class="nav-link" href="contact-us.php">Contact</a></li>
                  </ul>
                  ...
                  <ul class="navbar-nav justify-content-end2">
                      <li><a href="../contact-us.php" onclick="_blank">中文</a></li>
                      <li>|</li>
                            ...
                            <div class="contact_text">
                                ...
                                <div class="contact_d_list">
                                    <div class="contact_d_list_item">
                                        <a href="#"><i class="fa fa-phone"></i>&nbsp  Tel: +86-10-65265396</a>
                                        <a href="#"><i class="fa fa-fax"></i>  Fax: +86-10-65265503</a>
                                        <a href="#"><i class="fa fa-envelope-open"></i>  Email: info@saelinklaw.com</a>
                                        <a><i class="fa fa-map-marker"></i>   Location: 19th Floor, Block A, 7 Jianguomen South Ave. Beijing,  China</a>
                                        <a>Available: Mon.-Fri. 9:00-19:00</a>
                                    </div>
                                </div>
                                <div class="map_img">
                        ...
                        <div class="col-lg-6">
                            <div class="contact_form">
                                ...
                                <form class="contact_us_form row" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <textarea class="form-control" name="message" id="message" rows="1" placeholder="Type in the context"></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <button type="submit" value="submit" class="btn submit_btn2 form-control">>>Send Now</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h2>Sorry !</h2>
                        <p> Your message has not been sended... </p>
                    </div>
                </div>
            </div>
        </div>
