            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="contact-us.php">聯繫我們</a></li>
                    </ul>
                    <ul class="navbar-nav justify-content-end">
                        <li><a href="#"><i class="icon_search"></i></a></li>
                    </ul>
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="../contact-us.php">中文</a></li>
                        <li>|</li>
                        <li><a href="../en/contact-us.php" onclick="_blank">English</a></li>
						<li>|</li> 
						<li><a href="./contact-us.php" onclick="_blank">繁体</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                            ...
                            <div class="contact_text">
                                ...
                                <div class="contact_d_list">
                                    <div class="contact_d_list_item">
                                        <a href="#"><i class="fa fa-phone"></i>&nbsp  電話：+86-10-65265396</a>
                                        <a href="#"><i class="fa fa-fax"></i>  傳真：+86-10-65265503</a>
                                        <a href="#"><i class="fa fa-envelope-open"></i>  電郵：info@saelinklaw.com</a>
                                        <a><i class="fa fa-map-marker"></i>&nbsp&nbsp  地址：北京市建國門南大街7號A座19層</a>
                                        <a><i class="fa fa-clock-o"></i>&nbsp 辦公時間: 周壹~周五 9:00-19:00</a>
                                  </div>
                                </div>
                                <div class="map_img">
                        ...
                        <div class="col-lg-6">
                            <div class="contact_form">
                                ...
                                <form class="contact_us_form row" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="subject" name="subject" placeholder="咨詢主題">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <textarea class="form-control" name="message" id="message" rows="1" placeholder="請輸入咨詢內容"></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <button type="submit" value="submit" class="btn submit_btn2 form-control">立即發送</button>
                                    </div>
                                </form>
                            </div>
                        </div>
