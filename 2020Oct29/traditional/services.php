            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="../applications.php">中文</a></li>
                        <li>|</li>
                        <li><a href="../en/applications.php" onclick="_blank">English</a></li>
 						<li>|</li>
                        <li><a href="./applications.php" onclick="_blank">繁体</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                      ...
                      <div class="col-lg-9">
                          <div class="static_main_content">
                              ...
                              <div class="static_text2">
                                <h4>核心業務</h4>
                                <p>我們以代表客戶從事以下領域的訴訟及非訴服務而著稱：<br></p>
                                <ul>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=1">專利及商業秘密</a></li>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=2">反壟斷及反不正當競爭</a></li>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=3">商標、著作權及域名</a></li>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=4">數據合規、個人信息及大數據保護</a></li>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=5">商事訴訟及仲裁</a></li>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=6">跨境談判、知識產權許可及轉讓</a></li>
                                </ul>

                                <a class="read_btn" href="applications-more.php">顯示全部</a>
                                <br>
                                <p><br></p>
                                </div>
                                <div class="static_text2">
                                  <h4>服務行業</h4>
                                  <p>我們為不同行業及法律環境下的客戶提供創新、有效和實用的法律解決方案：<br></p>
                                  <ul>
                                    <li><a href="industry.php?id=1">電子與半導體</a></li>
                                    <li><a href="industry.php?id=2">信息技術、互聯網與電子商務</a></li>
                                    <li><a href="industry.php?id=3">制藥、生物技術與醫療健康</a></li>
                                    <li><a href="industry.php?id=4">化工、能源與環境工程</a></li>
                                    <li><a href="industry.php?id=5">機械與高端制造</a></li>
                                    <li><a href="industry.php?id=6">體育與文娛產業</a></li>
                                  </ul>

                                  <a class="read_btn" href="applications-industry.php">顯示全部</a>
                                  <br>
                                  </div>
                            </div>
                        </div>
