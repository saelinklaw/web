...
<html lang="en">
    <head>
		...
		$Sql="SELECT * FROM LegalResearch_TC WHERE ID ='".$ID."';" ;
        ...
        <title>世寧 法律研究 <?php echo $row['TITLE'] ?></title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="../research.php?id=<?php echo $ID?>">中文</a></li>
                        <li>|</li>
                        <li><a href="./en/research.php?id=<?php echo $ID?>" onclick="_blank">English</a></li>
												 <li>|</li> 
						<li><a href="research.php?id=<?php echo $ID?>" onclick="_blank">繁體</a></li>
                    </ul>
                </div>
            </nav>
        </header>
