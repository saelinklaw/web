...
?>
<body>
<form action="legalresearchupdate-submit.php" method="post" name="form1" id="form1">
  <table width="1000" border="0">
    <tbody>
      ...
      <tr>
        <td>CONTENTHTML</td>
        <td><textarea name="CONTENTHTML" cols="150" rows="35" id="CONTENTHTML"><?php echo $row['CONTENTHTML'] ?></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
