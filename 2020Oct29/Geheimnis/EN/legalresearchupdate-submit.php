...
<title></title>
	<?php
		...
		$Sql =  " UPDATE LegalResearch_TC SET TITLE ='{$TITLE}' WHERE ID ='".$ID."';" ;
		$uresult = $mysqli->query($Sql);
		$Sql =  " UPDATE LegalResearch_TC SET CONTENTHTML ='{$CONTENTHTML}' WHERE ID ='".$ID."';" ;
		#echo $Sql;
		$uresult = $mysqli->query($Sql);
		...
		$BackURL = "Liste-der-juristischen-Studien.php";
