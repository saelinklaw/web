    ...
    <tbody>
      ...
      <tr>
		...
		<?php
	     ...
	     $Sql="SELECT ID,NAME FROM SL_INDUSTRY ORDER BY ID ";
...
<?php
			$Sql="SELECT * FROM INDUSTRY_L1_CN  ORDER BY DATE DESC" ;
			$uresult = $mysqli->query($Sql);
?>
	...
	<?php
      ...
      <tr>
        ...
        <td><?php echo $row['NAME'] ?><textarea name="NAME2" cols="100" rows="5" id="NAME2"><?php echo $row['NAME'] ?></textarea></td>
