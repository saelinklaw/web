...
<html lang="en">
    <head>
		...
		$Sql="SELECT * FROM LegalResearch WHERE ID ='".$ID."';" ;
        ...
        <title>世宁 法律研究 <?php echo $row['TITLE'] ?></title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="./research.php?id=<?php echo $ID?>">中</a></li>
                        <li>|</li>
                        <li><a href="./en/research.php" onclick="_blank">EN</a></li>
												 <li>|</li> 
						<li><a href="./traditional/research.php?id=<?php echo $ID?>" onclick="_blank">繁</a></li>
                    </ul>
                </div>
            </nav>
        </header>
