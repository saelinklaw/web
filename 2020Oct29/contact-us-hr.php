            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="recruits.php">诚聘英才</a></li>
                        ...
                        <div class="col-lg-6">
                            <div class="contact_form">
                                ...
                                <form class="contact_us_form row" action="contact_process-hr.php" method="post" id="contactForm" novalidate="novalidate">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="subject" name="subject" placeholder="应聘职位">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <textarea  name="message" rows="10" class="form-control" id="message" placeholder="简历内容"></textarea>
                                    </div>
