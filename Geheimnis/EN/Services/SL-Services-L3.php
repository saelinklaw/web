...
<body>
<form action="SL-Services-S-L3.php" method="post" name="form1" id="form1">
    ...
    <tbody>
      ...
      <tr>
		...
		<?php
	     ...
	     $Sql="SELECT ID,NAME FROM SERVICES_ID_L2_EN ORDER BY ID ";
	     $uresult = $mysqli->query($Sql);
  ...
  <table width="1000" border="0">
	...
	<?php
			$Sql="SELECT * FROM SERVICES_ID_L3_EN ORDER BY DATE DESC" ;
			$uresult = $mysqli->query($Sql);
?>
	<?php
		while ($row = $uresult->fetch_assoc())
		...
		?>
      <tr>
        <td><?php echo $row['SL_SERVICES_ID'] ?></td>
