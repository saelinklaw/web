...
<html lang="en">
    <head>
		...
		$Sql="SELECT * FROM TEAM WHERE SL_ID ='".$ID."';" ;
		$uresult = $mysqli->query($Sql); 
		
		$row = $uresult->fetch_assoc();
		
		?>
        <title>世宁律师事务所 SAELINK LAW <?php echo $row['NAME'] ?></title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="prof-all.php">专业人员</a></li>
                    ...
                    <ul class="navbar-nav justify-content-end2">
						...
						<li>|</li>
                        <li><a href="./traditional/saelink-team.php?id=<?php echo $ID ?>" onclick="_blank">繁</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                          ...
                          <div class="static_main_content">
                            <div class="static_text2">
                                ...
                                <div class="people_text">
                                    <br>
                                    <h5>联系方式</5>
                                    <p><a href="#">电话：<?php echo $row['TELE'] ?></a></p>
                                    <p><a href="#">传真：<?php echo $row['FAX'] ?></a></p>
                                    <p><a href="mailto:<?php echo $row['EMAIL'] ?>">电邮：<?php echo $row['EMAIL'] ?></a></p>
                                    <br>
                                </div>
                                  ...
                                  <div class="col-lg-3">
		                           <div class="static_text3">
                                      <p><br></p>
										...
										<?php
									    	$Sql="SELECT * FROM V_SL_NEWS WHERE SL_ID ='".$ID."' ORDER BY DATE DESC;" ;
											$uresult = $mysqli->query($Sql);
                                    ...
                                    <div class="static_text2">
                                      <p><br></p>
                                        ...
                                        <ul>
										<?php
												$Sql="SELECT * FROM V_SL_SERVICES WHERE SL_ID ='".$ID."';" ;
												$uresult = $mysqli->query($Sql);
