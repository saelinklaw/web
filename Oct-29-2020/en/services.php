...
<html lang="en">
    <head>
        ...
        <title>SAELINK LAW世宁律师事务所 </title>
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav justify-content-end2">
                      <li><a href="../applications.php" onclick="_blank">中文</a></li>
                      <li>|</li>
                      <li><a href="./applications.php">English</a></li>
					 <li>|</li>
					  <li><a href="./applications.php">繁体</a></li>
                  </ul>
              </div>
          </nav>
      </header>
                      ...
                      <div class="col-lg-9">
                          <div class="static_main_content">
                              ...
                              <div class="static_text2">
                                <h4>Services</h4>
                                <ul>
                                  <li><a href="service-l2.php?SL_SERVICES_ID=1">Patent and Trade Secret</a></li>
                                  ...
                                  <li><a>Commercial Litigation and Arbitration</a></li>
                                </ul>
                                ...
                                <div class="static_text2">
                                  <h4>Industry</h4>
                                  <ul>
                                    <li><a>Information Technology，Internet and E-Commerce</a></li>
                                    <li><a>Electronics and Semiconductors</a></li>
                                    <li><a>Pharmaceutical, Biotechnology and Health Care</a></li>
                                    <li><a>Chemical，Energy and Environmental Engineering</a></li>
                                    <li><a>Sports and Entertainment</a></li>
                                    <li><a>Mechanical Engineering and High-End Manufacture</a></li>
									  
									<li><a>Telecommunications, Media and Technology</a></li>
                                    <li><a>Banking and Finance</a></li>
                                    <li><a>Consumer Products</a></li>
                                  </ul>
                                  <br>
                                  </div>
                            </div>
