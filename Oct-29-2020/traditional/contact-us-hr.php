    ...
    <body>
        ...
        <section class="search_area">
            <div class="search_inner">
                <input type="text" placeholder="請輸入搜索項...">
                <i class="ti-close"></i>
            </div>
        </section>
        <!--================End Search Area =================-->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="recruits.php">誠聘英才</a></li>
                    ...
                    <ul class="navbar-nav justify-content-end2">
						...
						<li>|</li> 
						<li><a href="./traditional/index.php" onclick="_blank">繁體</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="contact_form">
                                ...
                                <form class="contact_us_form row" action="contact_process-hr.php" method="post" id="contactForm" novalidate="novalidate">
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="姓名">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="請輸入郵件地址">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="subject" name="subject" placeholder="應聘職位">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <textarea  name="message" rows="10" class="form-control" id="message" placeholder="簡歷內容"></textarea>
                                    </div>
        ...
        <script src="js/contacthr.js"></script>
