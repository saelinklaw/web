...
<?php include("db.php"); ?>
	...
	<?php
		...
		$Sql="SELECT * FROM SL_INDUSTRY_CT WHERE ID ='".$ID."' ORDER BY DATE  ;" ;
		$uresult = $mysqli->query($Sql); 
		$row = $uresult->fetch_assoc();
		
		$NAME=$row['NAME'];
		
		$Sql="SELECT * FROM INDUSTRY_L1_CT WHERE SL_INDUSTRY_ID ='".$ID."' ORDER BY DATE  ;" ;
		$uresult = $mysqli->query($Sql); 
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="../industry.php">中文</a></li>
                        <li>|</li>
                        <li><a href="./en/telecom.html" onclick="_blank">English</a></li>
						<li>|</li>
                        <li><a href="industry.php">繁體</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                      ...
                      <div class="col-lg-3">
                        <div class="right_sidebar_area">
                            <aside class="right_widget r_cat_widget">
                                ...
                                <ul>
                                  <li><a href="#">信息技術、互聯網與電子商務</a></li>
                                  <li><a href="#">制藥、生物技術與醫療健康</a></li>
                                  <li><a href="#">機械與高端制造</a></li>
                                  <li><a href="#">化工、能源與環境工程</a></li>
                                </ul>
                            </aside>
                            <aside class="right_widget r_cat_widget">
                                <div class="r_w_title">
                                ...
                                <ul>
                                    <li><a href="#">專利與商業秘密</a></li>
                                    <li><a href="#"> 反壟斷及反不正當競爭</a></li>
                                    <li><a href="#"> 商標、著作權及域名</a></li>
                                    <li><a href="#"> 數據合規及個人信息保護</a></li>
                                    <li><a href="#"> 商事訴訟仲裁</a></li>
                                    <li><a href="#"> 跨境談判、知識產權許可及轉讓</a></li>
                                </ul>
                            </aside>
