...
<?php
		...
		$Sql =  "INSERT INTO TEAM (SL_ID,NAME,Position,TELE,FAX,EMAIL,EDU,Qualification,RESUME,RepresentativeCase,Date) VALUES  ('{$SL_ID}','{$Name}','{$Position}','{$Tele}','{$Fax}','{$EMail}','{$Edu}','{$Qualification}','{$Resume}','{$RepresentativeCase}',NOW())" ;
		echo $Sql;
		if(strlen($Name)>2)
		{
