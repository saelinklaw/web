...
<html lang="en">
    <head>
		...
		$Sql="SELECT * FROM SERVICES_ID_L2 WHERE SL_SERVICES_ID ='".$SL_SERVICES_ID."';" ;

		$L2 = $mysqli->query($Sql);
		
		$Sql="SELECT * FROM SL_SERVICES WHERE ID ='".$SL_SERVICES_ID."';" ;
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav justify-content-end2">
                        <li><a href="./service-l2.php?SL_SERVICES_ID=<?php echo $SL_SERVICES_ID ; ?>">中</a></li>
                        <li>|</li>
                        <li><a href="./en/patent.html" onclick="_blank">EN</a></li>
						<li>|</li>
                        <li><a href="./traditional/service-l2.php?SL_SERVICES_ID=<?php echo $SL_SERVICES_ID ; ?>">繁</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                      ...
                      <div class="col-lg-9">
                          <div class="static_main_content">
							  ...
							  <div class="static_text2">
                                ...
                                <ul>
									<?php
									$Sql="SELECT * FROM SERVICES_ID_L3 WHERE SL_SERVICES_L2_ID ='".$L2_ROW['ID']."';" ;
									$L3 = $mysqli->query($Sql);
                        ...
                        <div class="col-lg-3">
                            <div class="right_sidebar_area">
                              <aside class="right_widget r_cat_widget">
                                  ...
                                  <ul>
                                      <li><a href="antitrust.html"> 反垄断及反不正当竞争</a></li>
                                      <li><a href="trademark.html"> 商标、著作权及域名</a></li>
                                      <li><a href="dataprotect.html"> 数据合规及个人信息保护</a></li>
                                      <li><a href="businesssuit.html"> 商事诉讼仲裁</a></li>
                                      <li><a href="negotiation.html"> 跨境谈判、知识产权许可及转让</a></li>
                                  </ul>
                              </aside>
                              <aside class="right_widget r_cat_widget">
                                  <div class="r_w_title">
                                  ...
                                  <ul>
                                    <li><a href="information.html">信息技术、互联网与电子商务</a></li>
                                    <li><a href="telecom.html">电子与半导体</a></li>
                                    <li><a href="biology.html">制药、生物技术与医疗健康</a></li>
                                    <li><a href="entertainment.html">体育与文娱产业</a></li>
                                    <li><a href="chemical.html">化工、能源与环境工程</a></li>
                                  </ul>
                              </aside>
